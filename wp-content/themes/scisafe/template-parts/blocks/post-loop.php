...
<?php if ( have_posts() ) : ?>
    <div class="post-loop lg:pl-14" data-post-types='[<?php echo implode(', ', array_map('add_quotes', $post_type)); ?>]' data-posts-per-page="<?php echo $posts_per_page; ?>">
        ...
        <?php get_template_part( 'template-parts/components/pagination-infinite', '', ['max_pages' => $_query->max_num_pages] ); ?>
    </div>
<?php endif; ?>