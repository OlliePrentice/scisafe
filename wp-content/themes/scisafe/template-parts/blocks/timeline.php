...
<div class="timeline pl-14">
    <div class="bg-cover bg-center py-16 timeline__background relative gradient-wrap" <?php echo $background ? 'style="background-image: url('. $background .')"' : ''; ?>>
